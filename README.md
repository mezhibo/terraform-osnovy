...
- core_fraction=5 слишком маленькое значение, будем использовать core_fraction=20, т.к через веб интерфейс нам рекомендуют использовать именно его, хотя можем оставить и 5 но только в рамках standard-v1, в standard-v3 минимальное значение 20%


![alt text](https://github.com/mezhibo/terraform-osnovy/blob/941ea39cab9705650bf2801bc508e37f0d9006b9/IMG/10.jpg)

Это у нас гарантированная доля CPU, для себя решил 20%, по совету веб-интерфейса, хотя никто не мешал установить 5%, но изменив перед этим на platform_id на "standard-v2" либо "standard-v1"

![alt text](https://github.com/mezhibo/terraform-osnovy/blob/95f269a0fcd948e116c0731acf90e7b39af37b63/IMG/12.jpg)


Ну а меньше 5% нам уже никто не позволит создать (

![alt text](https://github.com/mezhibo/terraform-osnovy/blob/fcb66c1c7fbc49d5f89056e61e2f36c03c3e4b2f/IMG/13.jpg)
