...
- И изменим значения ресурсов на минимально допустимые, 1-ядро и 5% использования ЦП изменим на 20%, так как в веб-интерфйесе среди рекомендованных указано 20, хотя можно и 5%. Сделаю для себя 20 ради теста для первого задания.
