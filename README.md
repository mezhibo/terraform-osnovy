...
- И изменим значения ресурсов на минимально допустимые, 1-ядро недопустимо, делаем 2 ядра, оперативки оставим 1Гб, и 5% использования ЦП изменим на 20%, так как в веб-интерфйесе среди рекомендованных указано 20%, хотя можно и 5%. Сделаю для себя 20% ради теста для первого задания, потом в конце изменю на 5%
